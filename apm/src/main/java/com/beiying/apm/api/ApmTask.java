...
import com.beiying.apm.core.job.activity.ActivityStorage;
import com.beiying.apm.core.job.activity.ActivityTable;
import com.beiying.apm.core.job.appstart.AppStartStorage;
import com.beiying.apm.core.job.appstart.AppStartTable;
import com.beiying.apm.core.job.block.BlockStorage;
import com.beiying.apm.core.job.block.BlockTable;
import com.beiying.apm.core.job.fileinfo.FileInfoStorage;
import com.beiying.apm.core.job.fileinfo.FileTable;
import com.beiying.apm.core.job.fps.FpsStorage;
import com.beiying.apm.core.job.fps.FpsTable;
import com.beiying.apm.core.job.func.FuncStorage;
import com.beiying.apm.core.job.func.FuncTable;
import com.beiying.apm.core.job.memory.MemStorage;
import com.beiying.apm.core.job.memory.MemoryTable;
import com.beiying.apm.core.job.net.NetStorage;
import com.beiying.apm.core.job.net.NetTable;
import com.beiying.apm.core.job.processinfo.ProcessInfoStorage;
import com.beiying.apm.core.job.processinfo.ProgessInfoTable;
import com.beiying.apm.core.job.watchDog.WatchDogInfoStorage;
import com.beiying.apm.core.job.watchDog.WatchDogInfoTable;
import com.beiying.apm.core.job.webview.WebStorage;
import com.beiying.apm.core.job.webview.WebTable;
