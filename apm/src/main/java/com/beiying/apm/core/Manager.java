...
import com.beiying.apm.cleaner.DataCleaner;
...
import com.beiying.apm.network.UploadManager;
...
public class Manager {
    ...
    public void reload() {
        if (DEBUG) {
            LogX.d(TAG, SUB_TAG, "start reloadConfig");
        }
