...
@Navigator.Name("byfragment")
public class ByFragmentNavigator extends Navigator<ByFragmentNavigator.Destination> {
    ...
    public ByFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                             int containerId) {
        mContext = context;
    ...
    @NonNull
    @Override
    public ByFragmentNavigator.Destination createDestination() {
        return new ByFragmentNavigator.Destination(this);
    }
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull ByFragmentNavigator.Destination destination, @Nullable Bundle args,
...
//        ft.replace(mContainerId, frag);
        ...
        if (navigatorExtras instanceof ByFragmentNavigator.Extras) {
            ByFragmentNavigator.Extras extras = (ByFragmentNavigator.Extras) navigatorExtras;
    ...
    /**
     * NavDestination specific to {@link ByFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(ByFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link ByFragmentNavigator} which this destination
         *                          will be associated with. Generally retrieved via a
         *                          {@link NavController}'s
         *                          {@link NavigatorProvider#getNavigator(Class)} method.
         */
        public Destination(@NonNull Navigator<? extends ByFragmentNavigator.Destination> fragmentNavigator) {
         ...
         *                  destination
         * @return this {@link ByFragmentNavigator.Destination}
         */
        @NonNull
        public final ByFragmentNavigator.Destination setClassName(@NonNull String className) {
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        /**
         * Builder for constructing new {@link ByFragmentNavigator.Extras} instances. The resulting instances are
         * immutable.
         */
        public static final class Builder {
             ...
             * @return this {@link ByFragmentNavigator.Extras.Builder}
             */
            @NonNull
            public ByFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public ByFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
                mSharedElements.put(sharedElement, name);
                return this;
            }

            /**
             * Constructs the final {@link ByFragmentNavigator.Extras} instance.
             *
             * @return An immutable {@link ByFragmentNavigator.Extras} instance.
             */
            @NonNull
            public ByFragmentNavigator.Extras build() {
                return new ByFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
