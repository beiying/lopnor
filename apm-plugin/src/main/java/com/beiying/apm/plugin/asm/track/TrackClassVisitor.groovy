...
class TrackClassVisitor extends ClassVisitor implements Opcodes {
    private final
    static String SDK_API_CLASS = "com/beiying/apm/track/SensorsDataAutoTrackHelper"
    private String[] mInterfaces
    private ClassVisitor classVisitor

    private HashMap<String, TrackMethodCell> mLambdaMethodCells = new HashMap<>()

    TrackClassVisitor(final ClassVisitor classVisitor) {
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        methodVisitor = new TrackDefaultMethodVisitor(methodVisitor, access, name, desc) {
            ...
            void visitInvokeDynamicInsn(String name1, String desc1, Handle bsm, Object... bsmArgs) {
                ...
                try {
                    ...
                    TrackMethodCell sensorsAnalyticsMethodCell = TrackHookConfig.LAMBDA_METHODS.get(Type.getReturnType(desc1).getDescriptor() + name1 + desc2)
            ...
            protected void onMethodEnter() {
                 ...
                 */
                TrackMethodCell lambdaMethodCell = mLambdaMethodCells.get(nameDesc)
                if (lambdaMethodCell != null) {
                    ...
                    boolean isStaticMethod = TrackUtils.isStatic(access)
                    if (!isStaticMethod) {
            ...
            @Override
            AnnotationVisitor visitAnnotation(String s, boolean b) {//判断注解对应的方法是否需要埋点
                if (s == 'Lcom/beiying/apm/track/SensorsDataTrackViewOnClick;') {
