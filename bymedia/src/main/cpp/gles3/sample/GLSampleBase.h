...
#ifndef LOPNOR_GLSAMPLEBASE_H
#define LOPNOR_GLSAMPLEBASE_H
#include "stdint.h"
#include <GLES3/gl3.h>
#include <ImageDef.h>
...
#define DEFAULT_OGL_ASSETS_DIR "/sdcard/Android/data/com.beiying.media/files/Download"
...
public:
    ...
    virtual void LoadMultiImageWidthIndex(int index, NativeImage *pImage){};
...
protected:
    ...
    GLuint m_ProgramObj;
    BYNativeSyncLock m_lock;
    int m_SurfaceWidth;
    int m_SurfaceHeight;
};

#endif //LOPNOR_GLSAMPLEBASE_H
